...
function colorPicker(canvas, opts) {
	...
	window.addEventListener('touchend', function(e) {
		...
		console.info(colorPicker.getColorHSV().h*360);
		console.info(colorPicker.getColorHSV().s*360);
		console.info(colorPicker.getColorHSV().v*360);
	});
}
